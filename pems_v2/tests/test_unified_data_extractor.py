...
import pandas as pd
import pytest
from analysis.core.unified_data_extractor import (EnergyDataset,
                                                  QueryDefinition,
...
def mock_influxdb_client():
    ...
    with patch(
        "analysis.core.unified_data_extractor.InfluxDBClient"
...
class TestUnifiedDataExtractor:
    ...
    async def test_extract_complete_dataset_integration(
        ...
        with patch(
            "analysis.core.unified_data_extractor.get_room_power", return_value=1.5
        ):
