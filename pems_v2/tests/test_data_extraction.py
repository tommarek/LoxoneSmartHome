...
async def test_extract_energy_prices_with_mock(pems_test_settings):
    ...
    with patch('pems_v2.analysis.core.data_extraction.InfluxDBClient') as mock_client_class:
        ...
        assert 'from(bucket: "test_ote_prices")' in query_call or f'from(bucket: "{pems_test_settings.influxdb.bucket_prices}")' in query_call
